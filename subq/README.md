...
This project runs on **[Gald3r](https://github.com/wrm3/gald3r) for SubQ** -- file-based
...
Open this project in **SubQ** and run **`@g-setup`** -- it initializes gald3r and fills in
